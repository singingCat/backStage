		...
		<ButtonGroup size="small" class="btn-group">
			...
			<Input class="searchBox" size="small" v-model.trim="searchContent" placeholder="要搜索的内容">
				<Select v-model="searchType" slot="prepend" style="width: 100px">
		            ...
		            <Option value="userName">Facebook昵称</Option>
		        </Select>
	...
	export default {
		...
		methods: {
			loadList (page) {
				...
				let url = 'user/userAirdrop/list?page='+page+'&pageSize=10&type=3';
				if (this.searchType != '') {
					url = 'user/userAirdrop/list?page='+page+'&pageSize=10&type=3' + 
